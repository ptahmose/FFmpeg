...
int ff_alsa_demuxer;
int ff_alsa_muxer;
int avfilter_vsrc_mptestsrc;
int avfilter_vsrc_frei0r_src;
int avfilter_vf_yadif;
int avfilter_vf_tinterlace;
int avfilter_vf_super2xsai;
int avfilter_vf_subtitles;
int avfilter_vf_stereo3d;
int avfilter_vf_smartblur;
int avfilter_vf_pp;
int avfilter_vf_ocv;
int avfilter_vf_noise;
int avfilter_vf_mp;
int avfilter_vf_kerndeint;
int avfilter_vf_hue;
int avfilter_vf_hqdn3d;
int avfilter_vf_histeq;
int avfilter_vf_geq;
int avfilter_vf_frei0r;
int avfilter_vf_drawtext;
int avfilter_vf_delogo;
int avfilter_vf_decimate;
int avfilter_vf_cropdetect;
int avfilter_vf_colormatrix;
int avfilter_vf_boxblur;
int avfilter_vf_blackframe;
int avfilter_vf_ass;
int avfilter_asrc_flite;
int avfilter_af_resample;
int avfilter_af_ebur128;
...
int ff_fmt_convert_init_altivec;
int ff_fmt_convert_init_mips;
int ff_mpadsp_init_arm;
int ff_mpadsp_init_altivec;
...
int avfilter_vf_mpdecimate; 
int avfilter_vf_interlace;
...
int ff_vc1dsp_init_mmx;
int ff_vc1dsp_init_mmxext;
